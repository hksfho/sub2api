export default {
  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: 'How many USD balance the user receives for each 1 HKD paid',
        balanceRechargePreview: 'Preview: 1 HKD = {usd} USD',
  ...
  payment: {
    ...
    rechargeRatePreview: 'Current rate: 1 HKD = {usd} USD',
